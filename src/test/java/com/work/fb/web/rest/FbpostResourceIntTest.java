...
import com.work.fb.repository.FbpostRepository;
import com.work.fb.service.FbpostService;
import com.work.fb.service.dto.FbpostDTO;
import com.work.fb.service.mapper.FbpostMapper;
...
public class FbpostResourceIntTest {
    ...
    public void createFbpost() throws Exception {
        ...
        assertThat(testFbpost.getUserId()).isEqualTo(DEFAULT_USER_ID);
    ...
    public void updateFbpost() throws Exception {
        ...
        Fbpost testFbpost = fbpostList.get(fbpostList.size() - 1);
        assertThat(testFbpost.getUserId()).isEqualTo(UPDATED_USER_ID);
